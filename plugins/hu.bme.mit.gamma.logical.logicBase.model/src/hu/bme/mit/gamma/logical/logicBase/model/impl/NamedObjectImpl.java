 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.gamma.logical.logicBase.model.impl.NamedObjectImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedObjectImpl extends MinimalEObjectImpl.Container implements NamedObject {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.NAMED_OBJECT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.NAMED_OBJECT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.NAMED_OBJECT__NAME:
				return getName();
		}
